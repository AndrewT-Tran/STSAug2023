			...
			<%@ taglib prefix="form" uri="http://www.springframework.org/tags/form" %>
				...
				<%@ page isErrorPage="true" %>
					...
					<body>
						<div class="container">
							<nav class="my-3">
								<a class="btn btn-primary" href="/dashboard">Dashboard</a> | <a class="btn btn-success"
									href="/add/book">Add Book</a> | <a class="btn btn-danger" href="/logout">Logout</a>
							</nav>
					...
					<div class="my-2">
						<c:if test="${thisBook.user.id == currentUser.id}">
							<form method="post" action="/api/delete/book">
								<input type="hidden" value="${thisBook.id }" name="book" />
								<input type="submit" value="Delete" class="my-2 btn btn-danger" />
							</form>
						</c:if>
					</div>
					</body>
